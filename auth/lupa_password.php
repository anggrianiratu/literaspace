...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .info-badge span { font-size: .85rem; }
  ...
  <div class="card">
    ...
    <div class="form-side">
      <div class="form-header">
        <p class="form-eyebrow">Pemulihan Akun</p>
        <h2 class="form-title"><em>Lupa</em> Password?</h2>
        <p class="form-desc">Masukkan email Anda dan kami akan mengirimkan link untuk mereset password Anda.</p>
      </div>
