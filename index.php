...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .search-input { width: 100%; padding: .6rem 2.2rem .6rem 1rem; background: var(--gray-50); border: 1.5px solid var(--gray-200); border-radius: 8px; font-family: 'DM Sans', sans-serif; font-size: .9rem; color: var(--gray-800); outline: none; transition: border-color .2s, box-shadow .2s; }
        ...
        .search-btn { position: absolute; right: .75rem; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: var(--gray-500); font-size: .85rem; transition: color .2s; }
        ...
        .hero-eyebrow { display: inline-block; font-size: .75rem; font-weight: 600; letter-spacing: .12em; text-transform: uppercase; color: var(--amber); margin-bottom: .9rem; }
        .hero-title { font-family: 'Playfair Display', serif; font-size: clamp(2rem, 4vw, 3.2rem); line-height: 1.15; color: var(--white); margin-bottom: 1.1rem; }
        ...
        .btn-primary { padding: .75rem 1.5rem; background: var(--amber); color: var(--gray-800); border: none; border-radius: 9px; font-family: 'DM Sans', sans-serif; font-size: .9rem; font-weight: 700; text-decoration: none; cursor: pointer; transition: background .2s, transform .1s; display: inline-flex; align-items: center; gap: .4rem; }
        .btn-primary:hover { background: #e8a412; }
        .btn-primary:active { transform: scale(.98); }
        .hero-visual { display: flex; align-items: center; justify-content: center; }
        .book-stack { position: relative; width: 200px; height: 260px; }
        .book-stack .b { position: absolute; width: 140px; height: 190px; border-radius: 6px 12px 12px 6px; box-shadow: 0 12px 40px rgba(0,0,0,.35); }
        ...
        .see-all { font-size: .84rem; font-weight: 600; color: var(--indigo-light); text-decoration: none; display: flex; align-items: center; gap: .3rem; white-space: nowrap; transition: color .2s; }
        ...
        .cover-placeholder { width: 100%; aspect-ratio: 3/4; display: flex; align-items: center; justify-content: center; }
        .cover-placeholder svg { width: 36px; height: 36px; fill: rgba(255,255,255,.4); }
        .cat-badge { position: absolute; top: 6px; left: 6px; background: rgba(255,255,255,.92); color: var(--indigo-deep); font-size: .68rem; font-weight: 700; padding: .15rem .5rem; border-radius: 9999px; letter-spacing: .03em; }
        .book-info { padding: .75rem; }
        .book-title-link { font-size: .84rem; font-weight: 600; color: var(--gray-800); display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; margin-bottom: .15rem; text-decoration: none; transition: color .2s; }
        ...
        .btn-cart { background: none; border: none; cursor: pointer; font-size: .95rem; color: var(--gray-500); padding: 0; transition: color .2s; display: flex; align-items: center; justify-content: center; }
        .btn-cart:hover { color: var(--indigo-light); }
        ...
        .promo-eyebrow { font-size: .72rem; font-weight: 700; letter-spacing: .12em; text-transform: uppercase; color: var(--amber); margin-bottom: .5rem; }
        .promo-title { font-family: 'Playfair Display', serif; font-size: 1.5rem; color: var(--white); margin-bottom: .6rem; }
        ...
        .promo-input { flex: 1; min-width: 200px; padding: .65rem 1rem; background: rgba(255,255,255,.1); border: 1.5px solid rgba(255,255,255,.25); border-radius: 8px; color: var(--white); font-family: 'DM Sans', sans-serif; font-size: .88rem; outline: none; transition: border-color .2s, background .2s; }
        ...
        .footer-logo-icon { width: 36px; height: 36px; background: var(--indigo-light); border-radius: 9px; display: flex; align-items: center; justify-content: center; margin-bottom: .7rem; }
        ...
        .social-btn { width: 36px; height: 36px; background: rgba(255,255,255,.08); border-radius: 8px; display: flex; align-items: center; justify-content: center; color: rgba(255,255,255,.65); text-decoration: none; font-size: .82rem; transition: background .2s, color .2s; }
...
<section class="hero">
    <div class="hero-inner">
        <div>
            ...
            <h1 class="hero-title">Jelajahi Dunia <em>Literatur</em> Tanpa Batas</h1>
...
<section class="section">
    <div class="section-inner">
                ...
                <div class="book-card">
                    <div class="cover-wrap">
                        <?php if (!empty($book['cover_image']) && $book['cover_image'] !== 'default.jpg'): ?>
                            <img src="./assets/covers/<?= htmlspecialchars($book['cover_image']) ?>" alt="<?= htmlspecialchars($book['judul']) ?>" style="width:100%; aspect-ratio:3/4; object-fit:cover; display:block;" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';" />
                            <div class="cover-placeholder" style="display:none; background:<?= $cover_gradients[$ci] ?>;"><svg viewBox="0 0 24 24"><path d="M12 2L2 7v10l10 5 10-5V7L12 2zm0 2.18L20 8.5v7L12 19.82 4 15.5v-7L12 4.18z"/></svg></div>
                        <?php else: ?>
                            <div class="cover-placeholder" style="background:<?= $cover_gradients[$ci] ?>;"><svg viewBox="0 0 24 24"><path d="M12 2L2 7v10l10 5 10-5V7L12 2zm0 2.18L20 8.5v7L12 19.82 4 15.5v-7L12 4.18z"/></svg></div>
                        <?php endif; ?>
                    </div>
                    <div class="book-info">
        ...
        <?php else: ?>
            <div class="empty-state"><i class="fas fa-inbox"></i><p>Belum ada buku yang tersedia.</p></div>
        <?php endif; ?>
    </div>
</section>
...
<section class="section section-alt">
    <div class="section-inner">
        ...
        <?php if (!empty($fantasy_books)): ?>
            <?php $fantasy_gradients = ['linear-gradient(135deg,#1a1040,#4a2f9a)','linear-gradient(135deg,#7b2d8b,#c77dff)','linear-gradient(135deg,#2d1b69,#8b5cf6)','linear-gradient(135deg,#0f0c29,#302b63)']; ?>
            <div class="books-grid-4">
                ...
                <div class="book-card">
                    <div class="cover-wrap">
                        <?php if (!empty($book['cover_image']) && $book['cover_image'] !== 'default.jpg'): ?>
                            <img src="./assets/covers/<?= htmlspecialchars($book['cover_image']) ?>" alt="<?= htmlspecialchars($book['judul']) ?>" style="width:100%; aspect-ratio:3/4; object-fit:cover; display:block;" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';" />
                            <div class="cover-placeholder" style="display:none; background:<?= $fantasy_gradients[$ci] ?>;"><svg viewBox="0 0 24 24"><path d="M12 2L2 7v10l10 5 10-5V7L12 2zm0 2.18L20 8.5v7L12 19.82 4 15.5v-7L12 4.18z"/></svg></div>
                        <?php else: ?>
                            <div class="cover-placeholder" style="background:<?= $fantasy_gradients[$ci] ?>;"><svg viewBox="0 0 24 24"><path d="M12 2L2 7v10l10 5 10-5V7L12 2zm0 2.18L20 8.5v7L12 19.82 4 15.5v-7L12 4.18z"/></svg></div>
                        <?php endif; ?>
            ...
            <div class="books-grid-4">
                ...
                <div class="book-card">
                    <div class="cover-wrap">
                        ...
                        <?php else: ?>
                            <div class="cover-placeholder" style="background:linear-gradient(135deg,#2d1b69,#8b5cf6);"><svg viewBox="0 0 24 24"><path d="M12 2L2 7v10l10 5 10-5V7L12 2z"/></svg></div>
                        <?php endif; ?>
